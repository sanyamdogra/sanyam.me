...
_It's very tough, **noobs** have nothing to do with **Google Summer Of Code**._
...
I believe that **_Life is all about converting an Exit(0) into Exit(1)._**
...
_" We are participating in @gsoc this year! The project lives at [Cynthesize](http://GitHub.com/Cynthesize). We're working with @HasuraHQ's @GraphQL engine with the frontend in @angular and looking for collaborators!"._
...
That day I realized that _things go wrong when you least expect them to._
...
May 6, 2019, was the Result announcement day. I was at a family function but I always had an eye on the clock. Soon it was 11:30 pm and I got a call from my friend. His words were **"_Bhai tera ho gaya! (You have made it!)_ "**. I opened my dashboard and refreshed it. It showed  
**_My Project- Complete the React Web Toolkit, Mentors- Silvio Relli and Francesco Zaia_**. My level of happiness rose to ecstatic

Next day I got the **acceptance mail** and realized that it was happening for real.

### Celebrare

I was receiving good wishes from my family and friends then a message popped up in my slack. It was from my mentor Francesco and it said _**" Hey! You well deserved it with your proposal and bright help so far. We'll catch up soon, for now just have a cake or something to celebrate"**_. It is still one of my best messages till date.
